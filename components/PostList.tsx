...
export const PostList: React.FC<Props> = ({ posts, onPreview, onDelete, onApprove }) => {
    // Sort by date desc
                    ...
                    <div key={post.id} className={`bg-white p-4 rounded-xl shadow-sm border ${isApproved ? 'border-green-200 ring-1 ring-green-100' : 'border-gray-100'} flex gap-4 transition-all`}>
                        ...
                        <div className="flex-1 min-w-0 flex flex-col justify-between">
                            ...
                            <div className="mt-3 flex gap-2 justify-end">
                                <button 
                                    onClick={() => onPreview(post)}
                                    className="text-xs text-primary hover:text-green-800 font-bold px-2 py-1 transition"
                                >
                                    Ver Detalle
                                </button>
                                <button 
